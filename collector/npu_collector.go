...
var (
	...
	npuChipInfoDescDevProcessInfo = prometheus.NewDesc("npu_chip_info_process_info",
		...
		[]string{"id", "vdie_id", "process_id", "container_id", "container_name", "pcie_bus_info"}, nil)
